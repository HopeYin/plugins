...
Before applying this bundled guide for a latest/current/default model upgrade, run `scripts/resolve-latest-model-info` from the OpenAI Docs skill directory.
